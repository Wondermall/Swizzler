...
// Swizzler
#define COCOAPODS_POD_AVAILABLE_Swizzler
#define COCOAPODS_VERSION_MAJOR_Swizzler 0
#define COCOAPODS_VERSION_MINOR_Swizzler 1
#define COCOAPODS_VERSION_PATCH_Swizzler 0
